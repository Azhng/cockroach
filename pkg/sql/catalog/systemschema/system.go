...
-- maybe we should normalize this
...
var (
	...
	ExperimentalSQLStmtStatsTable = makeTable(descpb.TableDescriptor{
		...
		Columns: []descpb.ColumnDescriptor{
			...
			{Name: "failed", ID: 7, Type: types.Bool, Nullable: false},
			{Name: "opt", ID: 8, Type: types.Bool, Nullable: false},
			{Name: "implicit_txn", ID: 9, Type: types.Bool, Nullable: false},
			{Name: "vec", ID: 10, Type: types.Bool, Nullable: false},
			{Name: "full_scan", ID: 11, Type: types.Bool, Nullable: false},
			{Name: "count", ID: 12, Type: types.Int, Nullable: false},
			{Name: "first_attempt_count", ID: 13, Type: types.Int, Nullable: false},
			{Name: "max_retries", ID: 14, Type: types.Int, Nullable: false},
			{Name: "num_rows", ID: 15, Type: types.Float, Nullable: false},
			{Name: "num_rows_sd", ID: 16, Type: types.Float, Nullable: false},
			{Name: "parse_lat", ID: 17, Type: types.Float, Nullable: false},
			{Name: "parse_lat_sd", ID: 18, Type: types.Float, Nullable: false},
			{Name: "plan_lat", ID: 19, Type: types.Float, Nullable: false},
			{Name: "plan_lat_sd", ID: 20, Type: types.Float, Nullable: false},
			{Name: "run_lat", ID: 21, Type: types.Float, Nullable: false},
			{Name: "run_lat_sd", ID: 22, Type: types.Float, Nullable: false},
			{Name: "service_lat", ID: 23, Type: types.Float, Nullable: false},
			{Name: "service_lat_sd", ID: 24, Type: types.Float, Nullable: false},
			{Name: "overhead_lat", ID: 25, Type: types.Float, Nullable: false},
			{Name: "overhead_lat_sd", ID: 26, Type: types.Float, Nullable: false},
			{Name: "bytes_read", ID: 27, Type: types.Float, Nullable: false},
			{Name: "bytes_read_sd", ID: 28, Type: types.Float, Nullable: false},
			{Name: "rows_read", ID: 29, Type: types.Float, Nullable: false},
			{Name: "rows_read_sd", ID: 30, Type: types.Float, Nullable: false},
			{Name: "exec_count", ID: 31, Type: types.Int, Nullable: false},
			{Name: "exec_network_bytes", ID: 32, Type: types.Float, Nullable: false},
			{Name: "exec_network_bytes_sd", ID: 33, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage", ID: 34, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage_sd", ID: 35, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time", ID: 36, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time_sd", ID: 37, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages", ID: 38, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages_sd", ID: 39, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage", ID: 40, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage_sd", ID: 41, Type: types.Float, Nullable: false},
			{Name: "stats", ID: 42, Type: types.Bytes, Nullable: false},
		},
		NextColumnID: 43,
		Families: []descpb.ColumnFamilyDescriptor{
			{
	...
	ExperimentalSQLTxnStatsTable = makeTable(descpb.TableDescriptor{
		...
		Columns: []descpb.ColumnDescriptor{
			...
			{Name: "count", ID: 4, Type: types.Int, Nullable: false},
			{Name: "max_retries", ID: 5, Type: types.Int, Nullable: false},
			{Name: "num_rows", ID: 6, Type: types.Float, Nullable: false},
			{Name: "num_rows_sd", ID: 7, Type: types.Float, Nullable: false},
			{Name: "service_lat", ID: 8, Type: types.Float, Nullable: false},
			{Name: "service_lat_sd", ID: 9, Type: types.Float, Nullable: false},
			{Name: "retry_lat", ID: 10, Type: types.Float, Nullable: false},
			{Name: "retry_lat_sd", ID: 11, Type: types.Float, Nullable: false},
			{Name: "commit_lat", ID: 12, Type: types.Float, Nullable: false},
			{Name: "commit_lat_sd", ID: 13, Type: types.Float, Nullable: false},
			{Name: "bytes_read", ID: 14, Type: types.Float, Nullable: false},
			{Name: "bytes_read_sd", ID: 15, Type: types.Float, Nullable: false},
			{Name: "rows_read", ID: 16, Type: types.Float, Nullable: false},
			{Name: "rows_read_sd", ID: 17, Type: types.Float, Nullable: false},
			{Name: "exec_count", ID: 18, Type: types.Int, Nullable: false},
			{Name: "exec_network_bytes", ID: 19, Type: types.Float, Nullable: false},
			{Name: "exec_network_bytes_sd", ID: 20, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage", ID: 21, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage_sd", ID: 22, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time", ID: 23, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time_sd", ID: 24, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages", ID: 25, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages_sd", ID: 26, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage", ID: 27, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage_sd", ID: 28, Type: types.Float, Nullable: false},
			{Name: "stats", ID: 29, Type: types.Bytes, Nullable: false},
		},
		NextColumnID: 30,
		Families: []descpb.ColumnFamilyDescriptor{
			{
