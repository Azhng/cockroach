...
var (
	...
	ExperimentalSQLTxnStatsTable = makeTable(descpb.TableDescriptor{
		...
		Columns: []descpb.ColumnDescriptor{
			...
			{Name: "num_rows_sd", ID: 8, Type: types.Float, Nullable: false},
			{Name: "service_lat", ID: 9, Type: types.Float, Nullable: false},
			{Name: "service_lat_sd", ID: 10, Type: types.Float, Nullable: false},
			{Name: "retry_lat", ID: 11, Type: types.Float, Nullable: false},
			{Name: "retry_lat_sd", ID: 12, Type: types.Float, Nullable: false},
			{Name: "commit_lat", ID: 13, Type: types.Float, Nullable: false},
			{Name: "commit_lat_sd", ID: 14, Type: types.Float, Nullable: false},
			{Name: "bytes_read", ID: 15, Type: types.Float, Nullable: false},
			{Name: "bytes_read_sd", ID: 16, Type: types.Float, Nullable: false},
			{Name: "rows_read", ID: 17, Type: types.Float, Nullable: false},
			{Name: "rows_read_sd", ID: 18, Type: types.Float, Nullable: false},
			{Name: "exec_count", ID: 19, Type: types.Int, Nullable: false},
			{Name: "exec_network_bytes", ID: 20, Type: types.Float, Nullable: false},
			{Name: "exec_network_bytes_sd", ID: 21, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage", ID: 22, Type: types.Float, Nullable: false},
			{Name: "exec_max_mem_usage_sd", ID: 23, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time", ID: 24, Type: types.Float, Nullable: false},
			{Name: "exec_contention_time_sd", ID: 25, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages", ID: 26, Type: types.Float, Nullable: false},
			{Name: "exec_network_messages_sd", ID: 27, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage", ID: 28, Type: types.Float, Nullable: false},
			{Name: "exec_max_disk_usage_sd", ID: 29, Type: types.Float, Nullable: false},
			{Name: "stats", ID: 30, Type: types.Bytes, Nullable: false},
		},
		NextColumnID: 31,
		Families: []descpb.ColumnFamilyDescriptor{
			{
